...
const Hint = ()=>{
    return(<div className="relative h-[450px]">
        <div className="absolute inset-0 z-0">
            <Image className="!w-full object-cover !h-full" width={400} height={300} alt="banner" src={"/images/hint.png"} />
        </div>
        <div className="border border-[4px] opacity-60 border-[var(--main)] absolute z-1 h-[350px] w-1/2 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
