...
//         </div> */}
//         <div className={`top-0 fixed -z-5 w-full ${styles.videoContainer}`}>
...
//         </div>
//         <div className={`flex justify-between items-center ${styles.containerDiv}  layout-doc`}>
//             <div className="flex gap-4 md:gap-6 flex-col ">
//                 <h1 className="heading text-5xl md:text-7xl font-bold ">
//                     <span className="text-[var(--second)]">QILUMÈ</span>
//                 </h1>
//                 <h2 className="!text-[1.2rem] sm:!text-xl md:!text-3xl text-white font-medium">Designed for Beauty, Grounded in Wellness</h2>
//                 <p className="text-sm sm:text-[1rem] md:text-[1.2rem] !text-white">India’s Emerging Integrative Beauty & Wellness House</p>
//                 <div>
//                     <Link href={"/contact"}>
...
const Hero = ()=>{
    return(<div className="!pt-15 md:!pt-20 ">
        <div className={`top-0 fixed -z-5 w-full h-[500px] md:h-[650px] xl:h-[720px]`}>
            <video autoPlay loop muted className="w-full h-full object-cover scale-150 lg:scale-120">
                <source src="/videos/Welcome To Qilume.mp4" type="video/mp4" />
            </video>
        </div>
        <div className={styles.overlay}>
